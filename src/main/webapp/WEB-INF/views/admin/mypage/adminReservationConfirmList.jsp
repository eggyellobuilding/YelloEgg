			...
			<%@include file="../adminCommonsViews/adminNavi.jsp" %>
    			<div class="col-xs-10" style="padding:0px;padding-left:5px; border-left: 1px solid #E1E1E1; height:1900px; ">
      				<ul class="nav nav-tabs" >
      					<li class="active"><a href="adminReservationConfirmList.do" >예약 확인 내역</a></li>
				...
				<div class="container">
					<h2>예약 확인 내역</h2>
					<table id="reservationTable" class="table table-hover" style="margin-top:35px;overflow: auto;width:95%;" >
					<thead>
					<tr class="active">
						<th width="10%"  class="text-center">NO.</th>						
						<th width="10%"  class="text-center">등급</th>						
						<th width="10%"  class="text-center">예매자</th>						
					...
					<c:if test="${empty lists}">
						<tr>
							<td colspan="9" align="center">예매한 내역이 없습니다.</td>
						</tr>
					</c:if>
					<c:if test="${!empty lists}">
