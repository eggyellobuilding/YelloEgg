			...
			<%@include file="../adminCommonsViews/adminNavi.jsp" %>
    			<div class="col-xs-10" style="padding:0px;padding-left:5px; border-left: 1px solid #E1E1E1; height:1900px; ">
      				<ul class="nav nav-tabs" >
						...
						<li class="active"><a href="adminStoreBuyList.do">스토어 구매 내역</a></li>
						<li><a href="adminStoreCancelList.do">스토어 취소 내역</a></li>
					</ul>
				<div class="container">
					<h2>스토어 구매 내역</h2>
					<table id="storeBuyTable" class="table table-hover" style="margin-top:35px;overflow: auto;width:95%;" >
					<thead>
					<tr class="active">
						<th width="10%"  class="text-center">NO.</th>						
						<th width="10%"  class="text-center">등급</th>						
						<th width="10%"  class="text-center">구매자</th>						
						<th width="15%"  class="text-center">구매날짜</th>
						<th width="15%"  class="text-center">상품명</th>
					...
					<c:if test="${empty lists}">
						<tr>
							<td colspan="9" align="center">구매한 내역이 없습니다.</td>
						</tr>
					</c:if>
					<c:if test="${!empty lists}">
