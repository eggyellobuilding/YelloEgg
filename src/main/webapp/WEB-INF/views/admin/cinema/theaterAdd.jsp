		...
		<div class="container">
			...
			<div class="col-xs-10"
				...
				<div class="container">
					...
					<form class="form-inline">
						...
						<div class="dropdown btn-group">
							<button class="btn btn-default dropdown-toggle" type="button"
								aria-expanded="true" onclick="showCinema()" id="findCinemaBtn"
								style="position: relative;">
								영화관 선택 <span class="caret" id="caret"></span>
					...
					<form id="theaterNameSubmit" class="form-horizontal"
						action="adminTheaterAdd.do" method="POST">
						<c:forEach items="${ cinemaNameList }" var="cinemadto"
							varStatus="status">
							<div class="form-group" style="margin-top: 30px;">
								<label class="col-xs-1 control-label">${status.count} :
								</label> <input type="text" name="theatername"
									class="form-control theaterName" style="width: 50%;"
									value="${ cinemadto.THEATERNAME }">
							</div>
							<input type="hidden" name="theaterCinemaIdx"
								value="${ cinemadto.THEATERIDX }">
						</c:forEach>
