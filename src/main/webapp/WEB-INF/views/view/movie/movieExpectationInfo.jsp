		...
		<c:forEach var="Expectation" items="${ExpectationList}">
			...
			<ul class="col-xs-2"
				...
				<li
					...
					및 별점</li>
				<li
					style="height: 30px; width: 250px; border: 1px solid red; text-align: center; padding-top: 4px;">${Expectation.movieName }</li>
				<li
				...
				<div class="modal-dialog" style="width: 900px;">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-title" id="myModalLabel">${Expectation.movieName}</h4>
						</div>
						<div class="modal-body">
							<img alt="" src="${Expectation.movieTitleCut }"
								style="height: 250px; width: 200px; float: left; margin-right: 10px;">
							<div class="topInfo" style="margin-top: 60px;">개봉일:${Expectation.releaseDate}</div>
