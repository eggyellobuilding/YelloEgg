...
<body>
	...
	<div class="row" style="margin: 25px auto; padding-left: 100px;">
		<c:forEach var="office" items="${officeList}" varStatus="mo">
			...
			<ul class="col-xs-2"
				...
				<li
					style="height: 40px; width: 250px; border: 1px solid gray; padding-top: 10px; text-align: center;">평점 ${office.movieRepleScoreAvg}
						<span class="staravg"></span>
					</li>
				<li
					style="height: 30px; width: 250px; border: 1px solid gray;padding-top: 2px; font-size: 17px;">
					<span class="mg${office.movieGrade}" style="padding:3px; border-radius:5px; margin-left: 5px; margin-right: 5px;">${office.movieGrade}</span> 
					<span>${office.movieName}</span></li>
				<li
				...
				<div class="modal-dialog" style="width: 700px;">
					<div class="modal-content">
						<div class="modal-body">
							<img alt="" src="${office.movieTitleCut}" style="height: 250px; width: 200px; float: left; margin-right: 10px; margin-top: 20px;">
							<button type="button" class="close" data-dismiss="modal" aria-label="Close">
								<span aria-hidden="true">&times;</span>
							</button><div style="margin-top: 40px;font-size:25px;">
							<span class="mg${office.movieGrade}" style="padding:3px; border-radius:5px; margin-left: 10px; margin-right: 5px;">${office.movieGrade}</span>
							<span>${office.movieName}</span></div><hr>
							<div class="topInfo">개봉일:${office.releaseDate}</div>
							...
							<div>
								...
								<div class="starRev" style="padding-bottom: 10px;">
									...
									<span class="starR" onclick="starScore(3,${office.movieIdx})">별3</span> <span class="starR" onclick="starScore(4,${office.movieIdx})">별4</span>
									<span class="starR" onclick="starScore(5,${office.movieIdx})">별5</span>
									&nbsp;&nbsp;&nbsp;
									<input type="text" name="repleContent" style="width: 460px;" id="content${office.movieIdx}">
								...
								<div id="repList${office.movieIdx}">
								<c:forEach var="rep" items="${movieReple}">
									<div>
									<c:if test="${office.movieIdx==rep.repleMovieIdx}">
