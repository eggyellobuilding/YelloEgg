...
제3조. 약관 외 준칙
	본 약관에 명시되지 아니한 사항에 대해서는 전기통신기본법, 전기통신사업법, 전자상거래 등에서의 소비자보호에 관한 법률, 정보통신망 이용촉진 및 정보보호 등에 관한 법률 및 기타 관련 법령의 규정에 따릅니다.
제 4조. 용어의 정의
	...
	"휴면회원" : 메가박스 서비스를 이용한 마지막 날로부터 연속하여 12개월간 이용 내역이 없는 회원을 말합니다.
제 5조. 이용 계약의 성립
...
제 9조. 개인정보의 이용
	...
	회사는 다음의 각 호와 같은 경우에는 이용자의 동의 하에 개인정보를 제3자에게 제공할 수 있습니다. 이러한 경우에도 개인정보의 제3자 제공은 이용자의 동의 하에서만 이루어지며 개인정보가 제공되는 것을 원하지 않는 경우에는, 특정 서비스를 이용하지 않거나 특정한 형태의 판촉이나 이벤트에 참여하지 않으면 됩니다.
		1) 메가박스 사이트 유료 컨텐트 이용, 쇼핑몰에서의 물품구매 등 서비스 제공을 위해 이용자의 이름, 주소, 전화번호 등이 해당 유료 컨텐트 제공자, 쇼핑몰 업체, 배송업자에게 제공될 수 있습니다.
...
제 13조. 회원의 특전
	...
	회원은 회사가 사전 공지한 행사 및 이벤트의 참여를 통해 멤버십 포인트를 추가로 적립 받을 수 있습니다. 이 경우 적립되는 멤버십 포인트는 행사 공지 시 별도로 공지된 기준에 따라 적립되며, 이벤트 포인트는 VIP 선정기준에 제외됩니다.
	회원은 본인의 계정으로 적립된 멤버십 포인트를 타인에게 양도하거나 타인의 멤버십 포인트와 합산할 수 없습니다.
	이미 구매한 영화 티켓을 환불할 경우, 해당 멤버십 포인트는 적립 취소됩니다.
	멤버십 포인트는 최초 적립된 시점에서 24개월이 지난 시점의 해당 월 말일에 먼저 적립된 포인트부터 월 단위로 자동 소멸됩니다. 당사는 회원에게 제공되는 포인트의 소멸시효가 도래하여 포인트를 소멸시키는 경우, 포인트 소멸과 관련된 내용을 최소 15일 전 e-mail 또는 SMS를 발송하여 홈페이지에서 해당월 소멸 예정 포인트 확인이 가능하도록 조치 합니다.
	휴면계정으로 전환된 회원의 경우 휴면 기간 동안 로그인 및 포인트 적립 및 사용 등 메가박스에서 제공하는 서비스를 받을 수 없으며, 별도의 본인 인증 절차를 통해 휴면 계정에서 활동 계정으로 변경 시 지속적인 서비스를 받으실 수 있습니다.
	...
	2015년 11월 24일을 기준으로 멤버십 상품별 차감 포인트가 변경되어 적용됩니다. 2015년 11월 23일까지 적립된 포인트(상영일 기준: 2015년 11월 22일까지 관람한 영화)와 2015년 11월 24일부터 적립되는 포인트(상영일 기준: 2015년 11월 23일부터 관람하는 영화)는 멤버십 포인트 상품 차감 포인트가 상이하게 적용되며 차감 포인트 기준은 별도 홈페이지 공지에 따릅니다. 2015년 11월 23일까지 적립된 포인트와 2015년 11월 24일부터 적립되는 포인트는 분리되어 운영이 되며 2015년 11월 23일까지 적립된 포인트는 회원이 원할 시 2015년 11월 24일부터 적립된 포인트로 이관하여 적용 및 사용할 수 있습니다.
...
제 15조. 자격 상실 및 회원 서비스 혜택 제한
	...
	서비스 운영을 고의로 방해하는 행위를 하는 경우 (통보 당일 또는 3일의 사전 유예기간 부여)
...
- 서비스 이용기록, 포인트 적립 및 사용 기록, 접속로그, 쿠키, 접속IP정보, 결제기록, 단말기 제조사, 모델명, OS버전정보, push 수신 기록
...
3. 개인정보의 이용·보관 기간
메가박스중앙(주)는 개인정보의 수집 및 제공 받은 목적이 달성되면 개인정보를 파기함을 원칙으로 합니다. 다만, 다음
...
1. 회사는 고객의 요청에 의하여 해당 고객의 개인정보를 제 3자에게 제공하는 경우, 그 제공하는 목적, 제공하는 개인정보의 항목, 개인정보를 제공받는 자 및 그 보유 • 이용기간은 다음 표와 같습니다.
	...
	제공받는 자의 이용목적	-메가박스 포인트 적립 및 사용, 포인트 내역 제공 등 제휴 서비스 제공, 예매 정보 제공 등 제휴 서비스 제공 활동
	보유 및 이용기간 -해당 제휴사 회원 가입 시 동의한 보유 및 이용기간까지
				
2. 메가박스와 관련한 제휴 계약 등을 신규 체결 또는 상기 기재된 개인정보 제공업체와의 기존 계약을 해지할 수 있으며, 그 경우 개인정보를 제공받는 업체에 변경이 생길 수 있습니다. 변경사항은 발생 시 홈페이지를 통해 고지하거나 동의를 구한 후 업체에게 제공됩니다.
