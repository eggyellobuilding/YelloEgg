 	...
 	<div class="mypageHeader"><h2><b>My YelloMovie</b></h2></div>
		...
		<div style="margin-top: 67px; margin-left: 20px;">
 			<ul class="nav nav-pills">
  				<li role="presentation" class="active"><a href="mypageStoreBuyList.do">스토어 구매내역</a></li>
 				 <li role="presentation" ><a href="mypageStoreCancelList.do">스토어 취소내역</a></li>
			</ul>
 		</div>
 		<div id="divList">
		...
		<div style="text-align: center; margin-top: 15px;">
				<table class="table table-hover" >
					...
					<tr class="active">
						...
						<th width="30%"  class="text-center">취소가능일</th>
					</tr>
					</thead>
					<tbody>
						<tr>
