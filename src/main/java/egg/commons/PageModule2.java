...
public static String makePage(String pagename, int totalcnt, int listsize, int pagesize, int cp,int memberIdx) {
		...
		if (startpage < pagesize) {
			...
			sb.append("<li class=''><a href='"+pagename+"?memberIdx="+memberIdx+"&cp=");
